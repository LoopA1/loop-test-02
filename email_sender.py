"""
email_sender.py — email notification service for user events
"""
import smtplib
import json
import os
...
def send_password_reset(email: str, reset_token: str) -> dict:
...
def send_bulk_notification(user_emails: list, subject: str, body: str) -> dict:
...
def send_templated_email(to: str, template_name: str, variables: dict) -> dict:
    ...
    return send_email(to, subject_line, body)


def log_email_event(event_type: str, email: str, metadata: dict = None) -> None:
