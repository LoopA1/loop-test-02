...
class FileManager:
    ...
    def write_metadata(self, file_path: str, metadata: dict) -> None:
        """Write metadata JSON alongside a file."""
        meta_path = file_path + ".meta.json"
        with open(meta_path, "w") as f:
            json.dump(metadata, f)

    def cleanup_temp_files(self, temp_dir: str = "/tmp/uploads") -> int:
    ...
    def create_thumbnail(self, image_path: str, size: tuple = (128, 128)) -> str:
